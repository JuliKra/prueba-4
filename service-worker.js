...
//game
'js/juego/img/yuji-itadori.png',
'js/juego/img/eren-Jaeger.png',
'js/juego/img/Mikasa-Ackerman.png',
'js/juego/img/Tanjiro-Kamado.png',
'js/juego/img/saitama.png',
'js/juego/img/asuka langley.png',
'js/juego/img/logo.png',
'./js/juego/jquery.min.js',
'./js/juego/script.js',
'./js/juego/style.css',
